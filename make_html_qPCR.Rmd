...
spike_virus_conc <- 14245.6 # copies/ul viral suspension spiked in (Spike ID: S12)
...
read_these_sheets <- c('WW22_622_BCoV') # sheet name(s) in the raw data file (qPCR data dump) - Separate by comma (,)
