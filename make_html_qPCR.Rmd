...
spike_virus_conc <- (22123) * 5/4 # copies/ul viral suspension spiked in (Spike ID: S12; correction included)
...
read_these_sheets <- c('WW17-615_N1-N2')
title_name <- '6/15 Rice'
...
```{r percentreco, fig.width = 8}

plot_mean_sd_jitter(long_vol_qpcr_summary, long_vol_qpcr_raw, long_format = T, sample_var = 'Vaccine', exclude_sample = T, measure_var = 'Recovery fraction', x_var = WWTP, ylabel = 'Fraction of spike-in recovered') %>% print()
```
